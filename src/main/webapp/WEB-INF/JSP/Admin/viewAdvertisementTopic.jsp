                            ...
                            <tbody>
                                ...
                                <c:forEach items="${lstAdvertisementTopic}" var="entry">
                                    <tr>
                                        ...
                                        <td><a href="${pageContext.servletContext.contextPath}/editAdvertisement/${entry.topic_Id}" style="font-size: 22px;"><i class="fa fa-edit"></i></a></td>
                                        <td><a href="${pageContext.servletContext.contextPath}/deleteAdvertisement/${entry.topic_Id}" style="font-size: 22px;"><i class="fa fa-trash"></i></a></td>
