            ...
            <div class="content-page">
                  ...
                  <div id="myCarousel" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                      <div class="item active">
                        <img src="${pageContext.servletContext.contextPath}/webresource/user/userimages/img2-medium.jpg" alt="">
                        <div class="carousel-caption">
                          <p>Excepturi sint occaecati cupiditate non provident</p>
                        </div>
                      </div>
                      <div class="item">
                        <img src="${pageContext.servletContext.contextPath}/webresource/user/userimages/img1-medium.jpg" alt="">
                        <div class="carousel-caption">
              ...
              <div class="row front-team">
                <ul class="list-unstyled">
                  <li class="col-md-3">
                    <div class="thumbnail">
                      <img alt="" src="${pageContext.servletContext.contextPath}/webresource/user/userimages/img1-large.jpg">
                      <h3>
                  ...
                  <li class="col-md-3">
                    <div class="thumbnail">
                      <img alt="" src="${pageContext.servletContext.contextPath}/webresource/user/userimages/img4-large.jpg">
                      <h3>
                  ...
                  <li class="col-md-3">
                    <div class="thumbnail">
                      <img alt="" src="${pageContext.servletContext.contextPath}/webresource/user/userimages/img2-large.jpg">
                      <h3>
                  ...
                  <li class="col-md-3">
                    <div class="thumbnail">
                      <img alt="" src="${pageContext.servletContext.contextPath}/webresource/user/userimages/img5-large.jpg">
                      <h3>
