...
<body class="corporate">
    ...
    <script src="${pageContext.servletContext.contextPath}/webresource/user/userjs/gmaps.js" type="text/javascript"></script>
    <script src="${pageContext.servletContext.contextPath}/webresource/user/userjs/contact-us.js" type="text/javascript"></script>
