<%-- 
    Document   : header
    Created on : 19 Mar, 2019, 4:44:33 PM
    Author     : Hiral
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <link href="${pageContext.servletContext.contextPath}/webresource/user/usercss/themes/red.css" rel="stylesheet" id="style-color">
    ...
    <body class="corporate">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 additional-shop-info">
                        <ul class="list-unstyled list-inline">
                            <li><i class="fa fa-phone"></i><span>+91 9956874637</span></li>
                    ...
                    <div class="col-md-6 col-sm-6 additional-nav">
                        <ul class="list-unstyled list-inline pull-right">
                            <li><a href="${pageContext.servletContext.contextPath}/loginindex">Log In</a></li>
                            <li><a href="${pageContext.servletContext.contextPath}/registrationindex">Registration</a></li>
                        </ul>
                    </div>
                    <!-- END TOP BAR MENU -->
                </div>
        ...
        <div class="header">
            <div class="container">
                <a class="site-logo" href="index.html"><h1 style="color:tomato;"><b>Eleganza</b></h1></a>
