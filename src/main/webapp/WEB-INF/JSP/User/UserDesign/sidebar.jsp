<%-- 
    Document   : sidebar
    Created on : 19 Mar, 2019, 4:51:21 PM
    Author     : Hiral
--%>
...
<head>
  ...
  <link href="${pageContext.servletContext.contextPath}/webresource/user/usercss/uniform.default.css" rel="stylesheet" type="text/css">
...
<body class="corporate">
    <div class="sidebar col-md-3 col-sm-3">
            <ul class="list-group margin-bottom-25 sidebar-menu">
              ...
              <li class="list-group-item clearfix"><a href="#"><i class="fa fa-angle-right"></i> Change Password</a></li>
              <li class="list-group-item clearfix"><a href="#"><i class="fa fa-angle-right"></i> My account</a></li>
              <li class="list-group-item clearfix"><a href="#"><i class="fa fa-angle-right"></i> Appointment Schedule</a></li>
              <li class="list-group-item clearfix"><a href="#"><i class="fa fa-angle-right"></i>Email notifications </a></li>
              <li class="list-group-item clearfix"><a href="#"><i class="fa fa-angle-right"></i>Ask tips from Experts </a></li>
              <li class="list-group-item clearfix"><a href="#"><i class="fa fa-angle-right"></i> Feedback</a></li>
            </ul>
          </div>
</body>
</html>