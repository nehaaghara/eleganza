        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="${pageContext.servletContext.contextPath}/addPayment"><i class="fa fa-circle-o"></i> Add Payment</a></li>
                    <li><a href="${pageContext.servletContext.contextPath}/viewPayment"><i class="fa fa-circle-o"></i> View Payment</a></li>
                </ul>
            </li>
